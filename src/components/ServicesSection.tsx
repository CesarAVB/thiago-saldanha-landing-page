    ...
    <div className="container mx-auto px-4 lg:px-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {services.map((s, i) => (
          ...
          >
            {/* Hover Halo effect */}
            <div className="absolute -inset-0.5 bg-gradient-to-br from-primary/50 to-secondary/50 rounded-[2rem] opacity-0 group-hover:opacity-100 blur transition duration-500" />
            
            <div className="relative h-full glass-dark border border-white/5 rounded-[2rem] p-8 flex flex-col transition-all duration-500 group-hover:translate-y-[-8px]">
              ...
              <h3 className="font-heading font-bold text-2xl text-foreground mb-4 tracking-wide group-hover:text-primary transition-colors">
                {s.title}
              </h3>
